    ...
    <div class="app-content">
      ...
      <div class="content-body">
        <div class="container">
          ...
          $pesquisa = $conexao->query("SELECT * FROM cliente INNER JOIN endereco ON endereco_id_endereco = id_endereco INNER JOIN login ON login_id_login = id_login WHERE cliente.id_cliente = $id_vindo");
          while ($tabela = $pesquisa->fetch()) {
            $usuario = $tabela['nome_completo'];
            $email = $tabela['email_usuario'];
          ...
          ?>
            ...
            <div class="nav-tabs-responsive">
              <div class="card">
                <form action="../../controll/crud/editar/recebe_editar_cliente.php?id=<?= $id_vindo ?>" method="POST">
                        ...
                        <div class="card-body">
                          <div class="row">
                            <div class="col-12 col-lg-6">
                              <div class="form-group"><label>Primeiro nome</label> <input type="text" class="form-control" name="nome" value="<?= $nome ?>" required>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-12 col-md-6 col-lg-6">
                              <div class="form-group"><label>E-mail</label> <input type="text" name="email_cliente" class="form-control" value="<?= $email_cliente ?>" required> </div>
                              <div class="form-group"><label>CEP</label> <input type="text" class="form-control" name="cep" id="cep" value="<?= $cep ?>" onblur="pesquisacep(this.value);" required>
                              </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                              <div class="form-group"><label>Cidade</label> <input type="text" class="form-control" name="cidade" id="cidade" value="<?= $cidade ?>" required> </div>
                              <div class="form-group"><label>Telefone comercial</label> <input type="text" class="form-control" name="telefone_cont" value="<?= $telefone2 ?>"></div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-12 col-lg-6">
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                              <div class="form-group"><label>Estado</label>
                                <select class="form-control" name="uf" id="uf" value="<?= $uf ?>">
                          ...
                          <div class="row">
                            <div class="col-12 col-lg-6">
                              <div class="form-group"><label>Bairro</label> <input type="text" class="form-control" name="bairro" id="bairro" value="<?= $bairro ?>" required></div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-6">
                              <div class="form-group"><label>Complemento</label> <input type="text" class="form-control" name="complemento" value="<?= $complemento ?>"></div>
                            <?php
                          }
                            ?>
                            </div>
