        ...
        <div class="app-sidebar">
            ...
            <div id="sidebar-nav" class="sidebar-nav">
                ...
                <ul>
                    ...
                    <li><a href="#"><span class="sidebar-nav-icon fa fa-cog"></span> <span class="sidebar-nav-text">Configuração</span></a></li>
                </ul>
                <hr>
                <ul>
        ...
        <div class="app-content">
            ...
            <div class="content-body">
                <div class="container">
                    ...
                    $pesquisa = $conexao->query("SELECT * FROM `login` WHERE id_login = $id_session");
                    while ($resultado = $pesquisa->fetch()) {
                        $id = $resultado['id_login'];
                        $nome_completo = $resultado['nome_completo_login'];
                    ...
                    ?>
                        ...
                        <div class="nav-tabs-responsive">
                            <div class="card">
                                <form action="../../controll/crud/editar/recebe_editar_login.php?id=<?= $id ?>" method="POST">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 col-lg-6">
                                                            <div class="form-group"><label>Nome completo</label> <input type="text" class="form-control" name="nome_completo_login" value="<?= $nome_completo ?>" require></div>
                                                        </div>
                                                        <div class="col-12 col-md-6 col-lg-6">
                                                            <div class="form-group"><label>Email</label> <input type="email" class="form-control" name="email_usuario" value="<?= $email_usuario ?>" require></div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 col-lg-6">
                                                            <div class="form-group"><label>Nome da Loja</label> <input type="text" class="form-control" name="nome_loja" value="<?= $nome_loja ?>" require></div>
                                                        </div>
                                                        <div class="col-12 col-md-6 col-lg-6">
                                                            <div class="form-group"><label>Nova senha</label> <input type="password" class="form-control" name="senha_usuario"></div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 col-lg-6">
                                                            <div class="form-group"><label>Senha atual</label> <input type="password" class="form-control" name="senha_atual" required></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
