                ...
                <div class="container">
                    ...
                    <div class="nav-tabs-responsive">
                        <div class="card">
                            ...
                            $id = $_GET['id'];
                            ?>
                            <form action="../../controll/crud/cadastro/processa_eletronico.php?id=<?= $id ?>" method="post">
                    ...
                    <div class="form-group"><button type="submit" class="btn btn-primary mr-1">PROXIMO</button> 
