                ...
                <div class="container">
                    ...
                    <div class="nav-tabs-responsive">
                        <div class="card">
                            ...
                            ?>
                            <form action="../../../controll/crud/cadastro/processa_usuario.php" method="post">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-12 col-md-6 col-lg-6">
                                                        <div class="form-group"><label>Email</label> <input type="email" class="form-control" name="email_controle" required></div>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-6">
                                                        <div class="form-group"><label>Nome completo</label> <input type="text" class="form-control" name="nome_completo" required></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-md-6 col-lg-6">
                                                        <div class="form-group"><label>Senha</label> <input type="password" class="form-control" name="senha_controle"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
