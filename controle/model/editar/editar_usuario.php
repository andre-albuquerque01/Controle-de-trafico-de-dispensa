        ...
        <div class="app-content">
            ...
            <div class="content-body">
                <div class="container">
                    ...
                    $pesquisa = $conexao->query("SELECT * FROM `login` WHERE id_login = $id");
                    ...
                    ?>
                        ...
                        <div class="nav-tabs-responsive">
                            <div class="card">
                                <form action="../../../controll/crud/editar/recebe_editar_usuario.php?id=<?= $id ?>" method="POST">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-12 col-md-6 col-lg-6">
                                                            <div class="form-group"><label>Nome completo</label> <input type="text" class="form-control" name="nome_completo_login" value="<?= $nome_completo_login ?>" require></div>
                                                        </div>
                                                        <div class="col-12 col-md-6 col-lg-6">
