                    ...
                    <div class="page-header">
                        <div class="row">
                            ...
                            <div class="col-sm-1 col-md-5">
                                <form class="form-inline" method="GET" action="./enviar/mostrar_usuario.php">
                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                $pesquisa = $conexao->query("SELECT * FROM `login`
                                    ORDER BY nome_completo_login ASC LIMIT $inicio, $qtd_pg");
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(id_login) AS num_result FROM login ORDER BY nome_completo_login ASC");
                                    $row_pg = $select->fetch();
