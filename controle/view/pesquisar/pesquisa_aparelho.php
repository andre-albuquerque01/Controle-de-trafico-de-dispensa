                    ...
                    <div class="page-header">
                        <div class="row">
                            ...
                            <div class="col-sm-1 col-md-5">
                                <form class="form-inline" method="GET" action="./enviar/mostrar_aparelho.php">
                                    <div class="form-group">
                                        <input type="text" name="pesquisar" id="pesquisar" class="form-control" placeholder="Pesquise o modelo" style="margin-right: 10px;" required>
                                    </div>
                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                $pesquisa = $conexao->query("SELECT * FROM eletronico INNER JOIN cliente_eletronico ON cliente_eletronico.eletronico_id_eletronico = eletronico.id_eletronico 
                                    INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente INNER JOIN login ON cliente.login_id_login = login.id_login /*WHERE cliente.login_id_login = $id_session*/ ORDER BY modelo ASC LIMIT $inicio, $qtd_pg");
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(id_eletronico) AS num_result FROM eletronico  INNER JOIN cliente_eletronico ON cliente_eletronico.eletronico_id_eletronico = eletronico.id_eletronico 
                                        INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente  INNER JOIN login ON cliente.login_id_login = login.id_login /*WHERE cliente.login_id_login = $id_session */ ORDER BY modelo ASC");
                                    $row_pg = $select->fetch();
