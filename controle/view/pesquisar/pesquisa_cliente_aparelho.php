                    ...
                    <div class="page-header">
                        <div class="row">
                            ...
                            <div class="col-sm-1 col-md-5">
                                <form class="form-inline" method="GET" action="./enviar/mostrar_cliente_aparelho.php">
                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                $pesquisa = $conexao->query("SELECT * FROM cliente_eletronico INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente 
                                    INNER JOIN eletronico ON eletronico.id_eletronico = cliente_eletronico.eletronico_id_eletronico INNER JOIN login ON cliente.login_id_login = login.id_login /*WHERE cliente.login_id_login = $id_session*/ ORDER BY nome_completo ASC LIMIT $inicio, $qtd_pg");
                                ...
                                ?>
                                        <tr class="text-center">
                                            ...
                                            <td><?= $descricao ?> </td>
                                            <td>
                                                <a href="../model/editar/editar_cliente.php?id=<?= $id_cliente ?>" type="submit"><i class="bi bi-pencil-square"></i>Editar cliente</a>
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(cliente_id_cliente) AS num_result FROM cliente_eletronico INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente 
                                        INNER JOIN eletronico ON eletronico.id_eletronico = cliente_eletronico.eletronico_id_eletronico INNER JOIN login ON cliente.login_id_login = login.id_login /*WHERE cliente.login_id_login = $id_session*/");
                                    $row_pg = $select->fetch();
