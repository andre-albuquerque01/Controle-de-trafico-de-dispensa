                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                $consulta = $conexao->query("SELECT * FROM cliente_eletronico INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente 
                                        ...
                                        WHERE cliente.nome_completo LIKE '%$valor_pesquisar%' OR eletronico.modelo LIKE '%$valor_pesquisar%'");
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(cliente_id_cliente) AS num_result FROM cliente_eletronico INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente 
                                        INNER JOIN eletronico ON eletronico.id_eletronico = cliente_eletronico.eletronico_id_eletronico INNER JOIN login ON cliente.login_id_login = login.id_login WHERE cliente.nome_completo LIKE '%$valor_pesquisar%'");
                                    $row_pg = $select->fetch();
