                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                $consulta = $conexao->query("SELECT * FROM cliente INNER JOIN endereco ON endereco_id_endereco = id_endereco INNER JOIN login ON cliente.login_id_login = login.id_login WHERE cliente.nome_completo LIKE '%$valor_pesquisar%'");
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(id_cliente) AS num_result FROM cliente INNER JOIN endereco ON endereco_id_endereco = id_endereco INNER JOIN login ON cliente.login_id_login = login.id_login WHERE cliente.nome_completo LIKE '%$valor_pesquisar%'");
                                    $row_pg = $select->fetch();
