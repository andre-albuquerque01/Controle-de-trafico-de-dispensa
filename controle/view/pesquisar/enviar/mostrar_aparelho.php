                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                INNER JOIN login ON cliente.login_id_login = login.id_login WHERE modelo LIKE '%$valor_pesquisar%' OR marca LIKE '%$valor_pesquisar%'");
                                ...
                                <?php
                                    $select = $conexao->query("SELECT COUNT(id_eletronico) AS num_result FROM eletronico  INNER JOIN cliente_eletronico ON cliente_eletronico.eletronico_id_eletronico = eletronico.id_eletronico 
                                        INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente  INNER JOIN login ON cliente.login_id_login = login.id_login WHERE modelo LIKE '%$valor_pesquisar%' AND marca LIKE '%$valor_pesquisar%'
                                        ORDER BY modelo ASC");
                                    $row_pg = $select->fetch();
