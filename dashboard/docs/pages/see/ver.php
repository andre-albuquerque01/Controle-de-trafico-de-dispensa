        ...
        <div class="app-content">
            ...
            <div class="content-body">
                <div class="container">
                    <div class="page-header">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6">
                                ...
                                $id_vindo = $_GET['id'];
                                ?>
                                <form class="form-inline" method="POST" action="../adiconar_forms/adicionar.php?id=<?= $id_vindo ?>">
                    ...
                    INNER JOIN login ON login.id_login = cliente.login_id_login WHERE cliente_eletronico.cliente_id_cliente = $id_vindo");
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                INNER JOIN cliente_eletronico ON cliente_eletronico.eletronico_id_eletronico = eletronico.id_eletronico WHERE cliente_eletronico.cliente_id_cliente =  $id_vindo");
                                    while ($linha = $pesquisa->fetch()) {
                                        $id = $linha['id_reparo'];}
                                ?>
                                <form class="form-inline" method="POST" action="../editar/editar_aparelho_wreparo_data.php?id=<?= $id ?>">
                                ...
                                INNER JOIN eletronico ON eletronico.id_eletronico = cliente_eletronico.eletronico_id_eletronico INNER JOIN login ON cliente.login_id_login = login.id_login WHERE cliente.id_cliente = $id_vindo");
                                    ...
                                    ?>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td><?= $numero ?> </td>
                                            <td><?= $descricao ?> </td>
                                            <td><a href="../editar/editar_cliente.php?id=<?= $id_cliente ?>" type="submit"><i class="bi bi-pencil-square"></i>Editar cliente</a>
                                ...
                                INNER JOIN cliente_eletronico ON cliente_eletronico.eletronico_id_eletronico = eletronico.id_eletronico WHERE cliente_eletronico.cliente_id_cliente =  $id_vindo");
                                    ...
                                    ?>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a href="../editar/editar_aparelho_reparo.php?id=<?= ($id) ?>" type="submit"><i class="bi bi-pencil-square"></i>Editar</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
