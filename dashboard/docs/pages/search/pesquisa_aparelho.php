                    ...
                    <div class="page-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1 col-md-5">
                                <form class="form-inline" method="GET" action="../pesquisar/pesquisa_aparelho.php">
                                    <div class="form-group">Pesquisar&nbsp;
                                        <input type="text" name="pesquisa" class="form-control" id="exampleInputName2" placeholder="Pesquise o aparelho" style="margin-right: 10px;">
                                    </div>
                                    <button type="submit" class="btn btn-primary">Pesquisar</button>
                                </form>
                            </div>
                        ...
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                /*if (isset($_POST['filtro'])) {
                                    if ($_POST['filtro'] == 2) {
                                        $pesquisa = $conexao->query("SELECT * FROM eletronico ORDER BY modelo DESC LIMIT $inicio, $qtd_pg");
                                ...
                                ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td><a href="../editar/editar_aparelho.php?id=<?= $id ?>" type="submit"><i class="bi bi-pencil-square"></i>
                                                            Editar</a>
                            ...
                            <?php
                                            $select = $conexao->query("SELECT COUNT(id_eletronico) AS num_result FROM eletronico ORDER BY modelo ASC");
                                            $row_pg = $select->fetch();
                                ...
                                $pesquisa = $conexao->query("SELECT * FROM eletronico INNER JOIN cliente_eletronico ON cliente_eletronico.eletronico_id_eletronico = eletronico.id_eletronico 
                                        ...
                                        ORDER BY modelo ASC LIMIT $inicio, $qtd_pg");
                                if ($pesquisa && $pesquisa->rowCount() != 0) {
                                    while ($resultado = $pesquisa->fetch()) {
                                        $modelo = $resultado['modelo'];
                                        $marca = $resultado['marca'];
