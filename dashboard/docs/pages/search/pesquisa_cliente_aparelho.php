                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                INNER JOIN eletronico ON eletronico.id_eletronico = cliente_eletronico.eletronico_id_eletronico ORDER BY nome_completo ASC LIMIT $inicio, $qtd_pg");
                                ...
                                ?>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td><?= $numero ?> </td>
                                                <td><?= $descricao ?> </td>
                                                <td><a href="../editar/editar_cliente.php?id=<?= $id ?>" type="submit"><i class="bi bi-pencil-square"></i>Editar cliente</a>
                                                    <a href="../editar/editar_aparelho.php?id=<?= $id ?>" type="submit"><i class="bi bi-pencil-square"></i>Editar eletronico</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
                            ...
                            <?php
                                        $select = $conexao->query("SELECT COUNT(cliente_id_cliente) AS num_result FROM cliente_eletronico ORDER BY nome_completo ASC");
                                        $row_pg = $select->fetch();
                                        ...
                                        $pesquisa = $conexao->query("SELECT * FROM cliente_eletronico INNER JOIN cliente ON cliente.id_cliente = cliente_eletronico.cliente_id_cliente 
                                INNER JOIN eletronico ON eletronico.id_eletronico = cliente_eletronico.eletronico_id_eletronico ORDER BY nome_completo DESC LIMIT $inicio, $qtd_pg");
                                        while ($resultado = $pesquisa->fetch()) {
                                            $nome = $resultado['nome_completo'];
                                            $telefone = $resultado['telefone_celular'];
                                            $telefone2 = $resultado['telefone_contato'];
                            ...
                            <?php
                                        $select = $conexao->query("SELECT COUNT(cliente_id_cliente) AS num_result FROM cliente_eletronico ORDER BY nome_completo DESC ");
                                        $row_pg = $select->fetch();
                                        //echo $row_pg['num_result'];
                                        //Quantidade de paginas 
                                        $quantidade_pg = ceil($row_pg['num_result'] / $qtd_pg);
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(cliente_id_cliente) AS num_result FROM cliente_eletronico");
                                    $row_pg = $select->fetch();
                                    //echo $row_pg['num_result'];
                                    //Quantidade de paginas 
                                    $quantidade_pg = ceil($row_pg['num_result'] / $qtd_pg);
