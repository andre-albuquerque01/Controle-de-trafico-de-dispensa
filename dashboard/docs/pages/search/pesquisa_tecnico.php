    ...
    <div class="app">
        <div class="app-sidebar">
            ...
            <div id="sidebar-nav" class="sidebar-nav">
                ...
                <hr>
                <ul>
                    <li><a href="/docs/pages/content/signin.html"><span class="sidebar-nav-icon fa fa-power-off"></span> <span class="sidebar-nav-text">Log out</span></a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="content-body">
                <div class="container">
                    <div class="page-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1 col-md-5">
                                <form class="form-inline" method="GET" action="../pesquisar/pesquisa_tecnico.php">
                                    <div class="form-group">Pesquisar&nbsp;
                                        <input type="text" name="pesquisa" class="form-control" id="exampleInputName2" placeholder="Pesquise o tecnico" style="margin-right: 10px;">
                                    </div>
                                    <button type="submit" class="btn btn-primary">Pesquisar</button>
                                </form>
                            </div>
                    ...
                    <div class="align-items-center">
                        <div class="">
                            ...
                            <table class="table table-bordered table-hover text-center">
                                ...
                                /* if (isset($_POST['filtro'])) {
                                    if ($_POST['filtro'] == 1) {
                                        $pesquisa = $conexao->query("SELECT * FROM tecnico INNER JOIN endereco ON endereco_id_endereco = id_endereco ORDER BY nome_tecnico ASC LIMIT $inicio, $qtd_pg");
                                ...
                                ?>
                                            <tr class="text-center">
                                                ...
                                                <td><a href="../editar/editar_tecnico.php?id=<?= $id ?>" type="submit"><i class="bi bi-pencil-square"></i> Editar</a> </td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
                            ...
                            <?php
                                        $select = $conexao->query("SELECT COUNT(id_tecnico) AS num_result FROM tecnico ORDER BY nome_tecnico ASC");
                                        $row_pg = $select->fetch();
                                        ...
                                        $pesquisa = $conexao->query("SELECT * FROM tecnico INNER JOIN endereco ON endereco_id_endereco = id_endereco ORDER BY nome_tecnico DESC LIMIT $inicio, $qtd_pg");
                                        if ($pesquisa && $pesquisa->rowCount() != 0) {
                                        while ($resultado = $pesquisa->fetch()) {
                                            $nome = $resultado['nome_tecnico'];
                                            $telefone = $resultado['telefone_tecnico'];
                            ...
                            <?php
                                        $select = $conexao->query("SELECT COUNT(id_tecnico) AS num_result FROM tecnico ORDER BY nome_tecnico DESC LIMIT");
                                        $row_pg = $select->fetch();
                                        //echo $row_pg['num_result'];
                                        //Quantidade de paginas 
                                        $quantidade_pg = ceil($row_pg['num_result'] / $qtd_pg);
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(id_tecnico) AS num_result FROM tecnico");
                                    $row_pg = $select->fetch();
                                    //echo $row_pg['num_result'];
                                    //Quantidade de paginas 
                                    $quantidade_pg = ceil($row_pg['num_result'] / $qtd_pg);
