    ...
    <div class="app">
        ...
        <div class="app-content">
            ...
            <div class="content-body">
                    ...
                    <div class="page-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1 col-md-5">
                                <form class="form-inline" method="GET" action="../pesquisar/pesquisa_reparo.php">
                                    <div class="form-group">Pesquisar&nbsp;
                                        <input type="text" name="pesquisa" class="form-control" id="exampleInputName2" placeholder="Pesquise a data de entrega" style="margin-right: 10px;">
                                    </div>
                                    <button type="submit" class="btn btn-primary">Pesquisar</button>
                                </form>
                            </div>
                ...
                INNER JOIN endereco ON tecnico.endereco_id_endereco = endereco.id_endereco ORDER BY data_entrega ASC LIMIT $inicio, $qtd_pg");
                if ($pesquisa && $pesquisa->rowCount() != 0) {
                                ...
                                ?>
                                            <tr class="text-center">
                                                ...
                                                <td><a href="../editar/editar_Reparo.php?id=<?= ($id) ?>" type="submit"><i class="bi bi-pencil-square"></i> Editar</a> </td>
                                            </tr>
                            ...
                            <?php
                                        $select = $conexao->query("SELECT COUNT(id_reparo) AS num_result FROM reparo ORDER BY data_entrega ASC");
                                        $row_pg = $select->fetch();
                ...
                INNER JOIN tecnico  ON reparo.tecnico_id_tecnico = tecnico.id_tecnico 
                INNER JOIN eletronico ON reparo.eletronico_id_eletronico = eletronico.id_eletronico 
                INNER JOIN endereco ON tecnico.endereco_id_endereco = endereco.id_endereco ORDER BY data_entrega DESC LIMIT $inicio, $qtd_pg");
                if ($pesquisa && $pesquisa->rowCount() != 0) {
                                        while ($linha = $pesquisa->fetch()) {
                                            $id = $linha['id_reparo'];
                                            //Mudar para a data BR
                            ...
                            <?php
                                        $select = $conexao->query("SELECT COUNT(id_reparo) AS num_result FROM reparo ORDER BY data_entrega DESC");
                                        $row_pg = $select->fetch();
                                        //echo $row_pg['num_result'];
                                        //Quantidade de paginas 
                                        $quantidade_pg = ceil($row_pg['num_result'] / $qtd_pg);
                ...
                INNER JOIN endereco ON tecnico.endereco_id_endereco = endereco.id_endereco ORDER BY data_entrega DESC LIMIT $inicio, $qtd_pg");
                        ...
                        <?php
                                    $select = $conexao->query("SELECT COUNT(id_reparo) AS num_result FROM reparo");
                                    $row_pg = $select->fetch();
                                    //echo $row_pg['num_result'];
                                    //Quantidade de paginas 
                                    $quantidade_pg = ceil($row_pg['num_result'] / $qtd_pg);
