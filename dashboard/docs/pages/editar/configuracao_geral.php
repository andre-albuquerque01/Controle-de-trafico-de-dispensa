                ...
                <div class="container">
                    ...
                    ?>
                        ...
                        <div class="nav-tabs-responsive">
                            <div class="card">
                                <form action="../../crud/editar/recebe_editar_login.php?id=<?= $id ?>" method="POST">
                                            ...
                                            <div id="account-collapse" class="collapse show" data-parent="#tabContent">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-6">
                                                            <div class="form-group"><label>Senha</label> <input type="password" class="form-control" name="senha_usuario" value="<?= $senha_usuario ?>"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
