...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03/01/2022 às 20:45
...
--
ALTER TABLE `eletronico`
  MODIFY `id_eletronico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `reparo`
  MODIFY `id_reparo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
